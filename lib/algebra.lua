...
function trait_tick(a_trait, track)
  if (params:get(a_trait .. " sequence start " .. track) < params:get("current " .. a_trait .. " step " .. track)) and (params:get("current " ..a_trait.. " step " ..track) < params:get(a_trait..  " sequence end " ..track))
    then params:set(("current " .. a_trait ..  " step " .. track), params:get("current " .. a_trait ..  " step " .. track) + 1)
  elseif params:get("current " .. a_trait ..  " step " .. track) >= params:get(a_trait .. " sequence end " .. track)
    then params:set(("current " .. a_trait .. " step " .. track), params:get(a_trait .. " sequence start " .. track))
  elseif params:get("current " .. a_trait .. " step " .. track) < params:get(a_trait .. " sequence start " .. track)
    then params:set(("current " .. a_trait .. " step " .. track), params:get(a_trait .. " sequence start " .. track))
  elseif params:get("current " .. a_trait .. " step " .. track) == params:get(a_trait .. " sequence start " .. track)
    then params:set(("current " .. a_trait .. " step " .. track), params:get("current " .. a_trait .. " step " .. track) + 1)
  end
...
function determine_traits(track, flourish)
  ...
  note_traits.calculated.interval[track] = params:get("offset") + (params:get('key') + (collection_0[outer_index][inner_index] + 24) + ( 7 * params:get("transposition " ..track))) % 12
